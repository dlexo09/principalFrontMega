    ...
    return (
        <>
            <div className="container-fluid ventajasInternerMega">
                ...
                <p className="big-title text-center">Ventajas de elegir nuestro internet</p>
                <div className="container ventajas-internet-cards d-flex justify-content-center">
                    <div className="ventaja-internet-card">
                        <img src="/icons/router-icon.png" alt="Cobertura de señal óptima" />
                        <p>Equipo de última generación con al mejor cobertura de señal.</p>
                    </div>
                    <div className="ventaja-internet-card">
                        <img src="/icons/velocidad-simetrica-icon.png" alt="Velocidades simétricas" />
                        <p>Velocidades simétricas de subida y de bajada.</p>
                    </div>
                    <div className="ventaja-internet-card">
                        <img src="/icons/velocidad-subida-icon.png" alt="Mayor velocidad de subida" />
                        <p>Mayor velocidad de subida (Upload) automáticamente.</p>
                    </div>
                    <div className="ventaja-internet-card">
                        <img src="/icons/estabilidad-internet-icon.png" alt="Mejor estabilidad de internet" />
