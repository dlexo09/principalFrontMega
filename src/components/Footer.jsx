...
const Footer = () => {
  ...
  // Función para manejar el envío del formulario con la nueva API de inConcert
  const handleFooterSubmit = async (e) => {
    ...
    try {
      const result = await submitLeadToInConcert(telefono, 'footer');
      ...
      <div className="top-footer">
        <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center flex-wrap flex">
          <div className="contratar-container d-flex flex-column flex-lg-row align-items-center">
            ...
            <form className='form-footer d-flex flex-column flex-md-row' role="form" onSubmit={handleFooterSubmit}>   
              <input 
                type="text" 
        ...
        <div className="row">
          <div className="col-md-6 ps-4">
            <ul className="list-ct">
              ...
              <li class="list-ct-item"><a href="https://escala.megacable.com.mx/" target="_blank" rel="noopener noreferrer">Denuncias</a></li>
