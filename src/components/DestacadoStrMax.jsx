    ...
    return (
        ...
        <div className="destacados-str-max-container">
            ...
            <div className="destacados-str-max-img container-fluid d-flex justify-content-center">
                <img className='w-100 d-none d-md-block' src="../src/assets/images/streamings/max/destacados-max.png" alt="Max Destacados" />
                <img className='w-100 d-md-none' src="../src/assets/images/streamings/max/destacados-max-movil.png" alt="Max Destacados" />
            </div>
        </div>
        </>
    );
