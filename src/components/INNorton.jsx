...
const PaquetesTarifarios = () => {
  ...
  const paquetes = [
    {
      ...
      title: "Security",
      description:
        "Seguridad en tus dispositivos como smartphones, tablets y equipos portátiles",
      beneficios: [
        "Aplicación móvil.",
        "App lock.",
        "Password manager.",
    ...
    },
    {
      ...
      title: "Family",
      description:
        "Protege a los tuyos de contenidos no deseados y controla el tiempo en el que navegan en internet",
      beneficios: [
        "Aplicación móvil.",
        "Control Parental.",
      ...
      beneficioextra: "",
      precios: [
        { precio: "30", dispositivos: "10 dispositivos", padres: "2 padres" },
      ],
    },
    {
      id: 3,
      title: "Secure VPN",
      description:
        "VPN Segura agrega una protección extra al momento de conectarse vía wifi",
      beneficios: [
        "Aplicación móvil.",
  ...
  return (
    <>
      <Helmet>
        <title>
          Norton Antivirus | Megacable | Protege tus Dispositivos de Amenazas
        </title>
        <meta
          name="description"
          content="Protege tus dispositivos con Norton Antivirus, disponible con Megacable. Disfruta de protección avanzada contra virus, spyware y ataques cibernéticos. ¡No esperes más, protege tus datos!"
        />
      </Helmet>

      <div className="container general-tabs-container text-center pe-3 ps-3 pe-md-none ps-md-none">
        <h1 className="small-title-services">Norton</h1>
        <h3 className="big-title-services mb-5 title-especial">
          ¡Contrata Ya Tu servicio de Norton!
        </h3>
        <div
          id="carouselPaquetes"
              ...
              >
                <div className="d-flex justify-content-center slider-gp slider-innorton">
                  {chunk.map((paquete) => (
                    <div
                      key={paquete.id}
                      className="paquete-item paquete-item-innorton card m-2"
                    >
                      <div className="card-body card-body-innorton text-center">
                        <div className="header-zone">
                          <img
                            className="logo-servicio"
                            src="../src/assets/images/servicios/internet/norton-logo.png"
                            alt="Norton"
                          />
                          <h2 className="card-title-innorton">
                            {paquete.title}
                          </h2>
                          <p className="card-text-innorton mt-4">
                            {paquete.description}
                          </p>
                          <ul className="text-start benefits-list">
                            {paquete.beneficios.map((beneficio, i) => (
                              <li
                                key={i}
                                className="benefit-item d-flex align-items-center mt-2"
                              >
                                <img
                                  className="notron-logo-list"
                                  src="../src/assets/icons/servicios/internet/logo-norton-icon.png"
                                  alt="Norton incluye"
                                />
                                {beneficio}
                              </li>
                        ...
                        <div className="price-zone">
                          {paquete.precios.length > 1 ? (
                            <div className="precios-multiples d-flex justify-content-around align-items-center">
                              {paquete.precios.map((p, i) => (
                                <div key={i} className="precio-card-varios">
                                  <p className="precio-varios">
                                    <span className="dollar-icon">$</span>
                                    {p.precio}
                                    <br />
                                    <span className="time-pago">AL MES</span>
                                  </p>
                                  {p.padres && (
                                    <p className="detalles-precio">
                                      {p.padres}
                                    </p>
                                  )}
                                  <p className="dispositivos-precio">
                                    {p.dispositivos}
                                  </p>
                                </div>
                              ))}
                            ...
                            <div className="precio-unico mt-3">
                              <p className="precio-varios">
                                <span className="dollar-icon">$</span>
                                {paquete.precios[0].precio}{" "}
                                <span className="dollar-icon">AL MES</span>
                              </p>
                              <p className="mt-2">
                                {paquete.precios[0].dispositivos}
                              </p>
                              {paquete.precios[0].padres && (
                                <p className="detalles-precio">
                                  {paquete.precios[0].padres}
                                </p>
                              )}
                        ...
                        <button className="btn btn-packs btn-pack-card mt-3">
                          ¡Lo quiero!
                        </button>
                      </div>
                    </div>
