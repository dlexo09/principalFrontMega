            ...
            <div className="plans-contrata-prime d-flex justify-content-center">
              ...
              <div className="row d-flex plan-content-prime">
                <div className="col-md-4 col-g-6">
                  <img
                    src="/img/streamings/amazon/amazon-compras.png"
                    alt="Amazon Compras"
                  />
                ...
                <div className="col-md-4">
                  <img
                    src="/img/streamings/amazon/prime-video.png"
                    alt="Prime Video"
                  />
                  <h3>Prime video</h3>
                  <p>
                ...
                <div className="col-md-4">
                  <img
                    src="/img/streamings/amazon/la-casa-de-chivas.png"
              ...
              <div className="row d-flex plan-content-prime">
                <div className="col-md-4">
                  <img
                    src="/img/streamings/amazon/amazon-music.png"
                    alt="Amazon Music"
                  />
                  <h3>Amazon Music</h3>
                  <p>
                ...
                <div className="col-md-4">
                  <img
                    src="/img/streamings/amazon/prime-gamming.png"
                    alt="Prime Gaming"
                  />
                  <h3>Prime Gaming</h3>
                  <p>
                ...
                <div className="col-md-4">
                  <img
                    src="/img/streamings/amazon/rappi-pro.png"
                    alt=""
                  />
                  <h3>Rappi Pro</h3>
                  <p>
                        ...
                        <div className="card-body">
                          ...
                          {paquete.archivo && (
                            <div className="xview-content">
                              ...
                              <p>
                                <img
                                  src={`${paquete.ruta}${paquete.archivo}`}
                          ...
                          <div className="promoExtra">
                            <div className="pack-str-container">
                              ...
                              <div className="membresia-prime">
                                <img
                                  src="/img/streamings/amazon/amazon-prime-logo.png"
                                  alt=""
                                />
                              </div>
                            </div>
