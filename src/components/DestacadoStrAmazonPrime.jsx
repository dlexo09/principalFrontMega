    ...
    return (
        ...
        <div className="destacados-str-prime-container">
            ...
            <div className="destacados-str-prime-img container-fluid d-flex justify-content-center">
                <img className='w-100 d-none d-md-block' src="../src/assets/images/streamings/amazon/destacados-prime.png" alt="" />
                <img className='w-100 d-md-none' src="../src/assets/images/streamings/amazon/destacados-prime-movil.png" alt="" />
            </div>
        </div>
        </>
    );
