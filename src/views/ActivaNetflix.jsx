  ...
  <div className="activar-cuenta-container">
    <div className="container">
      <div className="text-center activar-cuenta-logo">
        <img src="/img/streamings/netflix/mega-netflix-logo.png" alt="Netflix Logo" />
        <p className="mt-4">
  ...
  <div className="container mt-5">
    ...
    <div className="activar-cuenta_tutorial">
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/ELTo-_6mmrs?si=lRTbAPg9yCh52LRd"
