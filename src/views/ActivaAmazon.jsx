...
const ActivaAmazon = () => {
  ...
  return (
    <ActivarCuenta title="AMAZON PRIME">
...
const Header = () => (
  <div className="text-center">
    <h2 className="small-title-services">Activa Tu Cuenta Amazon</h2>
    <h3 className="big-title-services big-title-container-sm">
      Ingresa tus datos de servicios en línea para activar tu cuenta de Amazon
    </h3>
  </div>
);
...
// Datos de los pasos
const stepsData = [
  "Suscríbete a Amazon Prime agregándolo a tu paquete de Mega. Si cuentas con una suscripción activa con Amazon, deberás de eliminar tu método de pago y esperar a que concluya tu periodo cubierto, posteriormente podrás realizar la vinculación utilizando tu misma cuenta. Tus compras e información dentro de las apps no se verán afectados.",
  ...
  "Después de colocar tu usuario y contraseña, selecciona “Enviar” y serás re-direccionado a una página de Amazon Prime.",
  "Dentro de la página de Amazon Prime Necesitas una cuenta (usuario y contraseña) para usar la App. Si ya tienes una, coloca tu cuenta actual, de lo contrario, llena la información solicitada y crea una nueva.",
  "Recibirás un código en tu correo para confirmar tu compra.",
  ...
  <div className="activar-cuenta-container">
    <div className="container">
      <div className="text-center activar-cuenta-logo">
        <img src="/img/streamings/amazon/mega-amazon-logo.png" alt="Amazon Prime Logo" />
        <p className="mt-4">
...
const TutorialSection = () => (
  <div className="container mt-5">
    <div className="text-center">
      ...
      <h2 className="big-title-services">Activa tu cuenta de Amazon Prime con Mega</h2>
    </div>
    <div className="activar-cuenta_tutorial">
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/A1Vy8azf3J4?si=DllKi9SVBqQuDLwb"
