    ...
    <ActivarCuenta title="AMAZON PRIME">
      ...
      <div className="activar-cuenta-container">
        <div className="container">
          <div className="text-center activar-cuenta-logo">
            <img src="../src/assets/images/streamings/amazon/mega-amazon-logo.png" alt="" />
      ...
      <div className="container mt-5">
        ...
        <div className="activar-cuenta_tutorial">
          <iframe width="560" height="315" src="https://www.youtube.com/embed/A1Vy8azf3J4?si=DllKi9SVBqQuDLwb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
